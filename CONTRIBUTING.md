...
Thanks for your interest in improving the Grok Telegram Bot!
...
- `src/grok` — Grok ACP bridge: client (`grok agent stdio`), transport, types, models, session log
...
Open an issue using the bug template. Include your OS, Node version, Grok CLI
version (`grok --version`), and relevant log lines from
`logs/grok-telegram-bot.log` (redact any secrets).
